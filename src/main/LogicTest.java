...
public class LogicTest {
	...
	public final void testAddCommand() {
		...
		assertTrue(myLogic.processCommand("delete all"));
		assertTrue(myLogic.processCommand("undo"));
		assertTrue(myLogic.processCommand("redo"));
		...
		assertFalse(myLogic.processCommand("add progress report by 9/11 2pm"));

		

		assertTrue(myLogic.processCommand("add proposal plant by 9/11 2359"));
		assertTrue(myLogic.processCommand("add proposal planning date by 9/11 2300"));
		...
		assertTrue(myLogic.processCommand("add annual customer meetings from 10/11 to 12/11"));
